...
const RoomDetails = () => {
  ...
  return (
    <section>
      <ScrollToTop />
      {/* banner */}
      <div className="bg-room bg-cover bg-center relative flex items-center justify-center h-[560px]">
        {/* overlay */}
        <div className="absolute w-full h-full bg-black/70"></div>
        {/* title */}
        <h1 className="drop-shadow-xl text-4xl sm:text-6xl text-white z-20 font-primary text-center px-6">
          {name} Details
        </h1>
      </div>
